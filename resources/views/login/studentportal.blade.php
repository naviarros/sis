...
<div class="main">
    <div class="container">
        ...
        <br><br>    
        <form method="post" action="{{ url('/students/message') }}">
            <label>Student Number:</label><br>
            @csrf
            <input class="w3-input" type="text"  name="stuname"  style="outline:none; "> <br>
            <label>Password:</label><br>
            <input class="w3-input" type="password"  name="stpword"style="outline:none; "><br>
            <a href="/login/studentforgot" style="color: blue;">Forgot Password?</a><br>
