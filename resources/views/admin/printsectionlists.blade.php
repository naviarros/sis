	...
	<div>
		<table id="customers" style="width: 100%">
			...
			<tbody>
				...
				<tr>
					<td>{{ $student->start_schyr}} - {{ $student->end_schyr}}</td>
					<td>{{ $student->section_description }}</td>
					<td>{{ $student->strand->description }}</td>
					<td>{{ $student->instructor->lastname }}, {{ $student->instructor->firstname}}</td>
				</tr>
				@endforeach
			</tbody>
		</table>
