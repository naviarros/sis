...
<body>
	...
	<table cellpadding="2">
		<tr>
			<td>Student Name:</td>
			<td><b>{{ $paymen->lastname}}, {{ $paymen->firstname}} {{ $paymen->middlename}}</b></td>
			<td>Grade Level:</td>
			<td><b>{{ $paymen->grade_level }}</b></td>
		</tr>
		<tr>
			<td>Strand/Track:</td>
			<td><b>{{ $paymen->strands->description}}</b></td>
			<td>Section Name:</td>
			<td><b>{{ $paymen->section->section_description }}</b></td>
		</tr>
	</table>
	<table id="customers" style="margin-top: 20px;">
		...
		<tbody>
			<tr>
				<td>{{ $paymen->payment->or_number}}</td>
				<td>{{ $paymen->payment->debit}}</td>
				<td>{{ $paymen->payment->credit}}</td>
				<td>{{ $paymen->payment->balance}}</td>
				<td>{{ $paymen->payment->payment_method}}</td>
			</tr>
		</tbody>
	</table>
</body>
