		...
		<table>
			<tr class="">
				<td>
					...
					<b><label>{{ session()->get('studentname')}}</label></b>
				</td>
				<td>
					<label class="align">Student Number:</label>
					<b><label>{{ session()->get('studentno')}}</label></b>
				</td>
			</tr>
			<tr>
				<td>
					<label>Section:</label>
					<b><label>{{ session()->get('section_name')}}</label></b>
				</td>
				<td>
					<label class="align">Strand:</label>
					<b><label>{{ session()->get('strand')}}</label></b>
				</td>
			</tr>
		</table>
	</div>
