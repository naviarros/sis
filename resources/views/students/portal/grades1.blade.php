...
<div class="panel-main-content">
	<div class="container-fluid">
		<p class="text-uppercase"><b>Learner Progress Achievement:</b></p>
	</div>
	...
	<div class="container-fluid">
		<p class="text-uppercase"><b>Observed Values:</b></p>
	</div>
	...
	<div class="container-fluid">
		...
		<div class="row ml-2">
			...
			<div class="form-group">
				<div class="col-md-12">
					<a href="/students/print" class="btn btn-info">PRINT <span class="fa fa-print"></span></a>
				</div>
			</div>
		</div>
					...
					<table class="table table-bordered mt-4 text-center">
						...
						<tbody>
							@foreach($gradeinfo as $grade)
								@if($grade->grade_level == '11')
									@if($grade->subjects->subject_type == 'Core Subject')
									<tr>
							...
							@foreach($gradeinfo as $grade)
								@if($grade->grade_level == '11')
									@if($grade->subjects->subject_type == 'Applied Subject' && $grade->subjects->subject_type == 'Specialized Subject')
									<tr>
										<td>{{ $grade->subjects->subject_description }}</td>
										<td>{{ $grade->mid_grade }}</td>
										<td>{{ $grade->final_grade }}</td>
				...
				<div class="tab-pane container fade" id="menu1">
			  		<table class="table table-bordered mt-4 text-center">
						...
						<tbody>
							@foreach($gradeinfo as $grade)
								@if($grade->grade_level == '11')
									@if($grade->subjects->subject_type == 'Core Subject' && $grade->semester == 'Second Semester')
									<tr>
										<td>{{ $grade->subjects->subject_description }}</td>
										<td>{{ $grade->mid_grade }}</td>
										<td>{{ $grade->final_grade }}</td>
							...
							@foreach($gradeinfo as $grade)
								@if($grade->grade_level == '11')
									@if($grade->subjects->subject_type == 'Applied Subject' && $grade->semester == 'Second Semester')
									<tr>
										<td>{{ $grade->subjects->subject_description }}</td>
										<td>{{ $grade->mid_grade }}</td>
										<td>{{ $grade->final_grade }}</td>
							...
							@foreach($gradeinfo as $grade)
								@if($grade->grade_level == '11')
									@if($grade->subjects->subject_type == 'Specialized Subject' && $grade->semester == 'Second Semester')
									<tr>
										<td>{{ $grade->subjects->subject_description }}</td>
										<td>{{ $grade->mid_grade }}</td>
										<td>{{ $grade->final_grade }}</td>
