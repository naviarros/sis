					  		...
					  		<table class="table table-bordered mt-4 text-center">
								<thead>
									...
									@foreach($gradesofstudent as $grade)
										@if($grade->grade_level == '11' && $grade->gr->subjects->subject_type == 'Applied Subject' || $grade->gr->subjects->subject_type == 'Specialized Subject' && $grade->grading_period == 'Second Semester'))
											<tr>
...
<div class="table12">
        ...
        @endforeach
				...
				<div id="grade12">
					<ul class="nav nav-tabs">
					  <li class="nav-item">
					    <a class="nav-link active text-dark" data-toggle="tab" href="#home2">1st Semester</a>
					  </li>
					  <li class="nav-item">
					    <a class="nav-link text-dark" data-toggle="tab" href="#menu12">2nd Semester</a>
					  </li>
					  <li class="nav-item">
					    <a class="nav-link text-dark" data-toggle="tab" href="#menu22">LEARNER'S OBSERVED VALUES</a>
					  </li>
					</ul>
				...
				<div class="tab-content">
					  <div class="tab-pane container active" id="home2">
							<table class="table table-bordered mt-4 ">
								...
								<tbody>
									@foreach($grades as $grade)
										@if($grade->grade_level == '12' && $grade->subjects->subject_type == 'Core Subject' && $grade->grading_period == 'First Semester')
											<tr>
												<td>{{ $grade->subjects->subject_description }}</td>
												<td>{{ $grade->mid_grade }}</td>
												<td>{{ $grade->final_grade }}</td>
									...
									@foreach($grades as $grade)
										@if($grade->grade_level == '12' && $grade->subjects->subject_type == 'Applied Subject' || $grade->subjects->subject_type == 'Specialized Subject ' && $grade->grading_period == 'First Semester')
											<tr>
												<td>{{ $grade->subjects->subject_description }}</td>
												<td>{{ $grade->mid_grade }}</td>
												<td>{{ $grade->final_grade }}</td>
					  		...
					  		<table class="table table-bordered mt-4 text-center">
								<thead>
									...
									<tr id="grades-second">
										<th colspan="5" class="text-left">Core</th>
										@foreach($grades as $grade)
										@if($grade->grade_level == '12' && $grade->subjects->subject_type == 'Core Subject'&& $grade->grading_period == 'Second Semester')
											<tr>
												<td>{{ $grade->subjects->subject_description }}</td>
												<td>{{ $grade->mid_grade }}</td>
												<td>{{ $grade->final_grade }}</td>
									...
									@foreach($gradesofstudent as $grade)
										@if($grade->grade_level == '12' && $grade->gr->subjects->subject_type == 'Applied Subject' || $grade->gr->subjects->subject_type == 'Specialized Subject' && $grade->grading_period == 'Second Semester'))
											<tr>
												<td>{{ $grade->gr->subjects->subject_description }}</td>
												<td>{{ $grade->gr->mid_grade }}</td>
												<td>{{ $grade->gr->final_grade }}</td>
          ...
          <label> Grading: </label> 
          <div class="col-md-4">
           <select class="form-control" name="grading2" id="grading2">      
           <option value="0"> </option>     
            <option value="1st">1st</option>
            <option value="2nd">2nd</option>
            <option value="3rd">3rd</option>
...
<div class="table12">
        <div  id="{{$corevalue->grading}}" class="grading2 {{$corevalue->grading}}">
        <table  class="table table-striped table-bordered">
          <thead>
            <tr>
          <th>Core Values</th>
