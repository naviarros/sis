...
<body>
   ...
   <a href="/classadvisorypdf" style="margin-left:0PX; margin-bottom: 20px;"class="btn btn-primary"> Generate Class Advisory</a>
     <div class="row">
 <label style="margin-left: -10px;">Section:</label><b> <label style="margin-left: 10px;">{{$class[0]->section->section_description}}</label> </b>
<label style="margin-left:80px;">Semester</label><b> <label style="margin-left: 10px;"> {{$class[0]->semester}}</label> </b>
  </div>
...
<table id="example" style="width: 100%" class="table table-striped table-bordered">
       ...
       @foreach($class as $classadvisory)   
          <tr>
               ...
               <td> <button class="btn btn-primary" data-toggle="modal"  data-studentid="{{$classadvisory->student_id}}" data-fullname="{{$classadvisory->lastname}} {{$classadvisory->firstname}} {{$classadvisory->middlename}}"  data-gradelevel="{{$classadvisory->section->grade_level}}" data-target="#corevalues"> Core Values</button> | <a href="/studentpdf/{{$classadvisory->student_id}}" class="btn btn-primary" ><span class="fa fa-print"></span> </a></td>
   ...
   <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <h4>Core Values</h4>
         ...
         <form method="post" action="{{route('corevalues')}}" id="corevalues">
   {{csrf_field()}}
   {{method_field('patch')}}
