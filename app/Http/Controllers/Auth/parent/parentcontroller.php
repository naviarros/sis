...
class parentcontroller extends Controller
{
    ...
    public function updateinformation(Request $request){
        ...
        $updateinformation->email= $request->get('email');
 ...
 alert()->success('Profiel Updated', 'Successfully Updated!');
    ...
    public function scheduleofstudent(){
         ...
         $schedule = section_sub::where('section_mid','=',$studentinformation[0]->section_mid)->where('semester','=',$studentinformation[0]->semester)->where('grade_level','=',$studentinformation[0]->grade_level)->get();
    ...
    public function gradesofstudent(){
      ...
      $grades = Grades::with('teacher')->where('student_id','=',$gradesofstudent[0]->student_id)->get();  
  ...
  //         } 
        ...
        return view('parent.grades',compact('gradesofstudent','corevalues','grades'));
    }
    ...
    public function parentforgot()
    {
        return view('login.parentforgot');
    }

    public function forgotpass(Request $request)
    {
        $guardian = Guardians::where('email', '=', $request->get('forgotparent'))->get();

        if(count($guardian))
        {
            Mail::to($guardian[0]->email)->send(new forgotParent($guardian[0]));
